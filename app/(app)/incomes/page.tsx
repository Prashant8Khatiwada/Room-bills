      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-border/60 pb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Log salary, freelance income, and borrowed loans with lender tags and loan debt summaries.
            </p>
          </div>
        ...
        {isWarningTriggered && (
          <div className="rounded-xl bg-amber-500/10 border border-amber-500/20 p-4 text-amber-800 dark:text-amber-300 flex items-start gap-3">
            ...
            <div className="space-y-1 text-xs">
              <p className="font-bold text-sm">Warning: Spending Limit Threshold Exceeded!</p>
              <p>
                Your total spending (Personal expenses: Rs. {totalPersonalSpent.toFixed(2)} + Room allocations: Rs. {totalAllocatedToRooms.toFixed(2)}) has crossed your warning limit of Rs. {warningLimit.toFixed(2)}.
              </p>
            </div>
          </div>
        )}
          ...
          <Card className="border-amber-500/30 bg-amber-500/5">
            <CardHeader className="pb-3">
              ...
              <CardDescription className="text-xs">
                Set a soft budget warning threshold for alerts.
              </CardDescription>
            </CardHeader>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-border/60 bg-card p-4">
            ...
            <p className="text-[11px] text-muted-foreground mt-1">Salary: Rs. {totalPersonalIncome}</p>
          </div>
          ...
          <div className="rounded-2xl border border-border/60 bg-card p-4">
            ...
            <p className="text-[11px] text-muted-foreground mt-1">{lendersSummary.length} lender records</p>
          </div>
          ...
          <div className="rounded-2xl border border-border/60 bg-card p-4">
            ...
            <p className="text-[11px] text-muted-foreground mt-1">Ready to allocate</p>
          </div>
        </div>

        {/* Loan Tracker Summary */}
        {totalLoansBorrowed > 0 && (
          <Card className="border-amber-500/30 bg-amber-500/5">
            <CardHeader className="pb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="lg:col-span-1 border-border">
            <CardHeader>
              ...
              <CardDescription>
                Record income or money borrowed from someone.
              </CardDescription>
            </CardHeader>
